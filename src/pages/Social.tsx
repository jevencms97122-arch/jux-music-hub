...
export default function Social() {
  ...
  const load = async () => {
    ...
    // Activité des amis (note : RLS limite listen_history à l'user lui-même,
    // donc on affiche uniquement les écoutes via play_count récents publics)
    if (followingIds.length > 0) {
      // Fallback : afficher derniers titres uploadés/likés par les amis (publics)
